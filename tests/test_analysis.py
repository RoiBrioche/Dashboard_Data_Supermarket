...
from app.analysis import (
    load_data, compute_kpis, sales_by_category, sales_over_time,
    profit_by_category, payment_distribution, top_products,
    customer_analysis, geographic_analysis, hourly_analysis, rating_analysis
)
...
def sample_dataframe():
    ...
    return pd.DataFrame({
        ...
        'Product line': ['Health and beauty', 'Electronic accessories', 'Fashion accessories', 'Food and beverages', 'Sports and travel'],
        ...
        'gross margin percentage': [4.761904762, 4.761904762, 4.761904762, 4.761904762, 4.761904762],
